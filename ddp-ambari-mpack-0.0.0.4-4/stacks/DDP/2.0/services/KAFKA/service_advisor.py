...
class DDP20KAFKAServiceAdvisor(service_advisor.ServiceAdvisor):

    def __init__(self, *args, **kwargs):
        self.as_super = super(DDP20KAFKAServiceAdvisor, self)
    ...
    def getServiceComponentLayoutValidations(self, services, hosts):
        items = super(DDP20KAFKAServiceAdvisor, self).getServiceComponentLayoutValidations(services, hosts)
        return items
    ...
    def validateConfigurationsForSite(self, configurations, recommendedDefaults, services, hosts, siteName, method):
        ...
        if properties:
            return super(DDP20KAFKAServiceAdvisor, self).validateConfigurationsForSite(configurations, recommendedDefaults, services, hosts, siteName, method)
        else:
            return []
