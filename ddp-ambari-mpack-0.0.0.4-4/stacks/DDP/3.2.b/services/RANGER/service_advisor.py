...
class RangerRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendRangerConfigurationsFromHDP206(self, configurations, clusterData, services, hosts):
    ...
    if rangerServiceVersion == '0.4.0':
      ...
      include_hdfs = "DDPS" in servicesList
      if include_hdfs:
      ...
      # For Ranger version 0.4.0
      ranger_services = [
        {'service_name': 'DDPS', 'audit_file': 'ranger-hdfs-plugin-properties'},
        ...
        if ranger_services[item]['service_name'] in servicesList:
          ...
          if component_audit_file in services["configurations"]:
            ranger_audit_dict = [
              ...
              {'filename': 'ranger-env', 'configname': 'xasecure.audit.destination.hdfs', 'target_configname': 'XAAUDIT.DDPS.IS_ENABLED'},
              {'filename': 'ranger-env', 'configname': 'xasecure.audit.destination.hdfs.dir', 'target_configname': 'XAAUDIT.DDPS.DESTINATION_DIRECTORY'}
            ]
  ...
  def recommendRangerConfigurationsFromHDP23(self, configurations, clusterData, services, hosts):
    ...
    ranger_services = [
      {'service_name': 'DDPS', 'audit_file': 'ranger-hdfs-audit'},
    ...
    required_services = [
      {'service_name': 'DDPS', 'config_type': 'ranger-hdfs-security'},
  ...
  def recommendRangerConfigurationsFromHDP25(self, configurations, clusterData, services, hosts):
    ...
    ranger_plugins_serviceuser = [
      {'service_name': 'DDPS', 'file_name': 'hadoop-env', 'config_name': 'hdfs_user', 'target_configname': 'ranger.plugins.hdfs.serviceuser'},
