...
class StormRecommender(service_advisor.ServiceAdvisor):
    ...
    def recommendStormConfigurationsFromHDP26(self, configurations, clusterData, services, hosts):
        """
         In DDP-2.6.1 we introduced a new way of doing Auto Credentials with services such as
         DDPS, HIVE, HBASE. This method will update the required configs for autocreds if the users installs
         STREAMLINE service.
         """
        storm_site = self.getServicesSiteProperties(services, "storm-site")
        ...
        if storm_env and storm_site and security_enabled and 'STREAMLINE' in servicesList:
            ...
            if storm_nimbus_autocred_plugin_classes is not None:
                ...
                putStormSiteProperty("nimbus.autocredential.plugins.classes", "['org.apache.storm.hdfs.security.AutoDDPS', 'org.apache.storm.hbase.security.AutoHBase', 'org.apache.storm.hive.security.AutoHive']")
            ...
            if storm_nimbus_credential_renewer_classes is not None:
                ...
                putStormSiteProperty("nimbus.credential.renewers.classes", "['org.apache.storm.hdfs.security.AutoDDPS', 'org.apache.storm.hbase.security.AutoHBase', 'org.apache.storm.hive.security.AutoHive']")
