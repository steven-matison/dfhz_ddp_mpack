...
class HDF20STORMServiceAdvisor(service_advisor.ServiceAdvisor):

    def __init__(self, *args, **kwargs):
        self.as_super = super(HDF20STORMServiceAdvisor, self)
    ...
    def getServiceComponentLayoutValidations(self, services, hosts):
        items = super(HDF20STORMServiceAdvisor, self).getServiceComponentLayoutValidations(services, hosts)
        return items
    ...
    def validateConfigurationsForSite(self, configurations, recommendedDefaults, services, hosts, siteName, method):
        ...
        if properties:
            return super(HDF20STORMServiceAdvisor, self).validateConfigurationsForSite(configurations, recommendedDefaults, services, hosts, siteName, method)
        else:
            return []
