...
class DDP30STORMServiceAdvisor(service_advisor.ServiceAdvisor):

    def __init__(self, *args, **kwargs):
        self.as_super = super(DDP30STORMServiceAdvisor, self)
    ...
    def getServiceComponentLayoutValidations(self, services, hosts):
        items = super(DDP30STORMServiceAdvisor, self).getServiceComponentLayoutValidations(services, hosts)
        return items
    ...
    def validateConfigurationsForSite(self, configurations, recommendedDefaults, services, hosts, siteName, method):
        ...
        if properties:
            return super(DDP30STORMServiceAdvisor, self).validateConfigurationsForSite(configurations, recommendedDefaults, services, hosts, siteName, method)
        else:
            return []
